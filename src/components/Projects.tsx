...
import projectBookMyTurf from '@/assets/project-bookmyturf.jpg';
import projectEventRegistration from '@/assets/project-event-registration.jpg';
...
const projects = [
  ...
  },
  {
    ...
    image: projectEventRegistration,
  },
];
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="glass-card relative z-10 p-8 h-full min-h-[400px] flex flex-col justify-end group-hover:border-primary/30 transition-all duration-500">
                {/* Tag */}
                <span className={`inline-block w-fit px-3 py-1 rounded-full text-xs font-semibold ${project.tagColor} mb-4`}>
                  {project.tag}
                </span>
                ...
                {/* Button */}
                <div>
                  <Button variant="heroOutline" className="group/btn">
                    View Project
