...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center pt-24 pb-16 px-6 relative"
    >
      <div className="max-w-7xl mx-auto w-full">
        <div className="max-w-3xl">
          ...
          >
            ...
            <br />
            <span className="text-foreground">I am passionate about coding.</span>
          </h1>
          ...
          >
            I focus on creating fast, functional, and user-friendly websites. I work with{' '}
          ...
          >
            ...
            <Button variant="heroOutline" size="lg" asChild>
              <a href="/resume.pdf" download="Navaneeth_Resume.pdf">
